CREATE TABLE products_warehouse_categories (
    ...
    CONSTRAINT fk_pwc_product_id FOREIGN KEY (product_id) REFERENCES products (id),
    CONSTRAINT fk_pwc_warehouse_product_category_id FOREIGN KEY (warehouse_product_category_id) REFERENCES warehouse_product_categories (id)
