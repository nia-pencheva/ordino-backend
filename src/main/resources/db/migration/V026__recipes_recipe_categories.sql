CREATE TABLE recipes_recipe_categories (
    ...
    CONSTRAINT fk_rrc_recipe_id FOREIGN KEY (recipe_id) REFERENCES recipes (id) ON DELETE CASCADE,
    CONSTRAINT fk_rrc_recipe_category_id FOREIGN KEY (recipe_category_id) REFERENCES recipe_categories (id) ON DELETE CASCADE
