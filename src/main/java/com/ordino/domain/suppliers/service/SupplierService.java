...
public class SupplierService {
    ...
    public SupplierProductResponseDTO getSupplierProduct(Long supplierId, Long supplierProductId) {
        ...
        SupplierProductResponseDTO responseDTO = new SupplierProductResponseDTO();
        responseDTO.setId(supplierProduct.getId());
        responseDTO.setProductName(supplierProduct.getWarehouseProduct().getProduct().getName());
        responseDTO.setUnitAbbreviation(supplierProduct.getWarehouseProduct().getUnit().getAbbreviation());
        responseDTO.setPrice(supplierProduct.getPrice());
        responseDTO.setMinOrderQuantity(supplierProduct.getMinOrderQuantity());
