...
@Component
public class NonLeafWarehouseProductCategoryParentIdValidator implements ConstraintValidator<NonLeafWarehouseProductCategoryParentId, Long> {
    ...
    public boolean isValid(Long parentId, ConstraintValidatorContext context) {
        ...
        return !repository.hasProducts(parentId);
    }
}
