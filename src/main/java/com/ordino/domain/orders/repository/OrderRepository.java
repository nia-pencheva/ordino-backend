...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    Page<Order> findBySupplierIdFiltered(@Param("supplierId") Long supplierId, @Param("from") Instant from, @Param("to") Instant to, @Param("orderStatus") String orderStatus, Pageable pageable);
    ...
    Page<Order> findBySupplierIdFilteredByReceivedAt(@Param("supplierId") Long supplierId, @Param("from") Instant from, @Param("to") Instant to, @Param("orderStatus") String orderStatus, Pageable pageable);
    ...
    Page<Order> findBySupplierIdAndWarehouseProductIdFiltered(@Param("supplierId") Long supplierId, @Param("warehouseProductId") Long warehouseProductId, @Param("from") Instant from, @Param("to") Instant to, @Param("orderStatus") String orderStatus, Pageable pageable);
    ...
    Page<Order> findBySupplierIdAndWarehouseProductIdFilteredByReceivedAt(@Param("supplierId") Long supplierId, @Param("warehouseProductId") Long warehouseProductId, @Param("from") Instant from, @Param("to") Instant to, @Param("orderStatus") String orderStatus, Pageable pageable);
}
