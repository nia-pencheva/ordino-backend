...
public class RecipeServiceImpl implements RecipeService {
    ...
    public RecipeEditDataResponseDTO getEditData() {
        ...
        responseDTO.setProductCategories(
            recipeIngredientCategoryRepository.findAllWithActiveProducts().stream()
    ...
    public RecipeForEditingResponseDTO getRecipeForEditing(Long id) {
        ...
        String statusName = recipe.getRecipeStatus().getStatus();
        boolean allowed = (principal.hasAnyAuthority("line cook") && Set.of("DRAFT", "RETURNED_FOR_REVISION").contains(statusName) && recipe.getCreatedBy().getId().equals(currentUserId))
                       || (principal.hasAnyAuthority("chef") && "DRAFT".equals(statusName) && recipe.getCreatedBy().getId().equals(currentUserId))
                       || (principal.hasAnyAuthority("chef") && "APPROVED".equals(statusName));
